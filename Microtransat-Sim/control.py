...
class Control(Module):
    def __init__(self):
        ...
        # self.dataInput = ArduinoInputData()
        self.dataOutput = ESP_data()
    ...
    def sweep(self):
        # if len(sys.argv) > 1:
        # self.target_sail_angle = Register(self.dataInput.getTargetSailAngle())
        # self.target_gimbal_rudder_angle = Register(self.dataInput.getTargetRudderAngle())
        self.dataOutput.setTargetRudderAngle(self.target_gimbal_rudder_angle._state)
